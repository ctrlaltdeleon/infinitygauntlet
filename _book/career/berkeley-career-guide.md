...
# Career Center Berkeley Job & Internship Guide
...
3. Career Fairs & Employer Info Sessions
4. Resume & Cover Letters
   ...
   4. References Layout
   5. Verb List for Resumes & Letters
...
- Informational Interview:
  ...
  - It is not a job interview & the objective is not to find job openings.
...
What's the tech stack that you work with & what do you like about it?
```
...
- Persistence, patience, early planning, passion, & commitment are key.
- Be aware of your social network presence.
- LinkedIn: Components of a Winning College Student Profile
  - Photo:
    - Keep it professional & make sure to smile! (Hint: Dress as if it’s your first day on the job in your industry)
  - Headline:
    - Tell everyone what you are majoring in & what types of careers you’re excited about. (i.e., Economics Student at UC Berkeley, Aspiring Financial Analyst)
  - Summary:
    - Tell your story! Describe what ignites your passion, what you're skilled at, & what's next.
  - Education:
    - List all the educational experiences you’ve had including some important coursework.
  - Experience:
    - List the jobs & internships you have held, even if they were part-time, along with what you accomplished at each.
  ...
  - Recommendations:
    ...
    - This gives extra credibility to your strengths & skills.
  - Join Groups:
    - By joining groups in your industries of interest you can meet other professionals, alumni, etc who share common interests.
    - You can learn a lot about your interest areas, including industry trends & news, by connecting to people & groups in LinkedIn.
...
- Possible Questions:
  ...
  - "Can you tell me about your career journey, & what led you here?"
  ...
  - "What types of skills & experience are you are seeking for this role?"
...
- What & Why:
  - "Created a website to generate community interaction between eager students & prospective employers."
- What, Why, & Result:
  - "Created a website to generate community interaction between eager students & prospective employers, resulting in connections with Playstation & Psyonix to name a few."
- Adding Adjectives:
  - "Created a full-stack application website using React/Redux/Firebase to generate community interaction between eager students & prospective employers, resulting in connections with Playstation & Psyonix to name a few."
...
### 4.5: Verb List for Resumes & Letters
...
- Connect your experiences & qualifications with the desired qualifications.
- Include specific information about why you want to work for the employer & industry.
- No grammar/spelling errors.
- Demonstrate knowledge of the position & the company.
...
Build connection between company's needs & your background &
skills...
Don't restate resume, expand on specifics...
"This is my top choice dream company & I'm willing to push
...
- Prepare the interview by doing said things:
  ...
  - Ask for feedback on the content & organization of your answers (completeness, level of detail, how easy to follow) & your presentation style (pace, voice quality/tone, energy, posture, eye contact, hand gestures).
  - Film or record your responses & review your performance.
  - Ask yourself:
    - “Did I look/sound confident, relaxed, & enthusiastic?”
    - “What does my body language say?”
    - “How were my pace & volume?”
- Types of interviews include:
  - One-on-one:
    - Just you & one interviewer, the most common type of interview.
  - Panel:
  ...
  - Working:
    - You are put to work & observed.
  - Phone or Video:
    - Often used as a screening tool before inviting you to an on-site interview.
  - On-Site or Second Round:
    - After you have made it through a screening interview, this is a more extended interview at the employer site that may include a series of different types of interviews, a site tour, & a meal.

### 5.1: Preparing for a Phone or Video Interview

- With these interviews, an employer is generally looking for clear interest, a positive attitude, solid communication, & evidence that conditions qualifications & experience for the position.
- General Tips:
  - Schedule where you can give 100% with no connection issues.
  - Prepare a list of points you want to make & questions to ask.
  - Keep a copy of your resume & position description nearby.
  - Have a calendar ready if incase rescheduling.
  - Listen & avoid interrupting, ask for clarification.
...
- Video Tips:
  ...
  - Dress up well & have no clutter in the background.

### 5.2: Preparing for a Second Round Interview

- At this point, you're being considered seriously for a position.
- They will see how you fit with company culture, with people, & absorb a more complete picture of what you offer.
- Use information based off the first interview to recognize your strengths, weaknesses, & overall stance.
- Before the Interview:
  ...
  - Have extra copies of your resume, transcripts, references, & all employer forms.
...
- What to Wear to Interviews:
  - Dependent on the industry & specific company culture.
  - Just look nice & groom well.
- At the Interview:
  - Be respectful.
  ...
  - If you are not ready, ask for written confirmation about the offer & tell the employer when you're ready.
- After the Interview:
  ...
  - A week after sending the thank-you, contact the employer to show your continued interest & ask if there is anything else to provide.
...
- These include traditional, behavioral, technical, & case.
- Traditional:
  - Straightforward questions about your experience, background, & personal qualities.
...
- Behavioral:
  ...
  - "Describe your leadership style & provide an example of a situation where you successfully led a group."
  - "How did you overcome "personality" conflicts in order to get results?"
- Technical:
  - Discipline-specific knowledge.
  - "When would you use == vs ===?"
  - "Explain the difference between React & JavaScript?"
...
- Actions:
  - "Within our Agile/Scrum meetings with 1 week sprints, I took on the majority of post creation & user settings. We worked on our separate tasks & when we met, we would teach each other specific libraries, code structure, & go through the application ourselves to QA, but ultimately see if it felt right."
- Result:
...
- "Tell me about your participation in religious/political/cultural/LGBT activity?"
  ...
  - Probe the interviewer to see what they like & build on that.

### 5.7: Questions to ask Employers

- Bring at least 5 questions to all interviews to ask employers.
- Shows interest, respect, & that you're ready.
- Must ask:
  - "Business card?"
...
- Ask:
  ...
  - "When & how are employees evaluated?"
...
- Offer letters provide formal written confirmation of the position offered, & clarification of terms such as:
  - Job title
  - Salary
  - Start date
  - Supervisor's name
...
- If it helps, draw it out, rank what you want & what you don't want.
- "Can I ask for more time?"
  - Yes, but be prepared to explain why & how much time you need.
  - A company who really wants you will speed up their process if possible.
- "How do I ask for more time?"
  - Be enthusiastic & thank the employer.
...
- "I forgot to respond to a company!"
  ...
  - Companies spend tons of money to recruit you so if you ignore the companies when they commit to you, you not only damage the company, but you also damage other applicants & yourself through networking you've done.
...
- Basic Salary Negotiation Principles:
  - Research the market salary range for your experience level & for the career role.
  ...
  - Public vs. Private!
    - Public usually has pre-determined salary while private companies will depend on several factors such as education, technical skills, & experience.
  ...
  - When you get an offer, ask for it in writing & ask the employer to clarify any aspects that aren't clear to you.
  - Be both assertive & cooperative.
  - If you are successful in your negotiation, ask for a new offer letter that reflects any changes.
- "What else can I negotiate?"
  - Start date.
  - Early performance review & salary review.
  - Vacation.
...
- Always be enthusiastic & respectful.

### 6.3: Accepting an Offer

- Sign & send it back to the employer by the agreed upon deadline.
- Keep a copy of the letter for future reference.
- If your application is pending with other employers, let them know that you have received an offer & wish to have your name withdrawn from further consideration.
- It is unethical to continue interviewing once you have accepted an offer.
- Inform your references & other contacts of your job or internship status.
- Thank them & periodically update them on your career trajectory.
...
- Contact the employer formally by email & indicate your appreciation for the offer & the opportunity to interview.
