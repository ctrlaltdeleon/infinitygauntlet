...
<Box fontSize={[6, 7]} p={4} color="navy" bg="magenta">
...
<Notes>
  These are speaker notes - And they won't be rendered in your slide
</Notes>
...
<Image src="https://source.unsplash.com/random/768x2048" size="contain" />
